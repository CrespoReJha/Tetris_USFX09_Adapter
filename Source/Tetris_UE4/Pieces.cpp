...
APieces::APieces()
{
    ...
    struct FConstructorStatics
    {
        ...
        FConstructorStatics()
            ...
            , Color_7(TEXT("Material'/Game/Mesh/Material_0.Material_0'"))
            , Color_8(TEXT("Material'/Game/Mesh/Material_1.Material_1'"))
            , Color_9(TEXT("Material'/Game/Mesh/Material_2.Material_2'"))
        {
        }
    };
